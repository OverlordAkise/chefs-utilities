...
net.Receive("luctus_namechange",function()
  ...
  NameFrame.Paint = function(self, w, h)
    ...
    draw.SimpleText("Welcome!", "Font", w/2, 15, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    draw.SimpleText("Please set your name", "Font", w/2, h/2 - 100, color_white, TEXT_ALIGN_CENTER)
  end
